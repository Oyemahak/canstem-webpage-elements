...
<style>
  ...
  .footer-separator {
    position: relative;
    height: 40px;
    background: linear-gradient(180deg, #eaf2ff 0%, #ffffff 90%);
    margin-top: 6px;
    z-index: 0 !important;
    pointer-events: none;
  }
  ...
  body.error404 #canstem-course-finder { position: relative; z-index: 500; }
  body.error404 #canstem-course-finder .csbx-suggest { z-index: 999999 !important; }
</style>
    ...
    <div class="wrap">
      ...
      <style>
        ...
        #canstem-course-finder .csbx-search {
          position:absolute; left:16px; top:50%; transform:translateY(-50%); width:20px; height:20px; color:#9aa5b1; pointer-events:none;
        }
        #canstem-course-finder .csbx-input {
        
          flex:1 1 auto; text-align: left; min-width:0; height:2.5rem; line-height:normal; padding:0; font-size:var(--csbx-font);
          color:var(--csbx-ink) !important; caret-color:var(--csbx-ink);
        }
        #canstem-course-finder .csbx-input::placeholder { color:#9aa5b1; opacity:1; }
        #canstem-course-finder .csbx-suggest {
          position:absolute; left:0; right:0; top:calc(100% + 10px); background:#fff; border:1px solid var(--csbx-border);
          border-radius:18px; box-shadow:var(--csbx-shadow); padding:8px; max-height:420px; overflow:auto; z-index:8; display:none;
        }
...
<script>
  (function () {
    const D9=[{code:"AVI1O",name:"Visual Arts"},{code:"ADA1O",name:"Drama"},
    ...
    const D10=[{code:"AVI2O",name:"Visual Arts (G10)"},
    ...
    const D11=[{code:"AVI3M",name:"Visual Arts (U/C)"},
    ...
    {code:"NBE3U",name:"Understanding Contemporary First Nations, Métis, and Inuit"},
    ...
    const D12=[{code:"ADA4E",name:"Drama (Workplace)"},
    ...
    const DESL=[{code:"ESLAO",name:"ESL Level 1"},
    ...
    const SITE_ITEMS=[
    //Pages
    {"title":"About Us","url":"/about-2/","category":"Page"},{"title":"Accessibility","url":"/accessibility/","category":"Page"},{"title":"Adult learning: Ontario high school diploma","url":"/adult-education/","category":"Page"},{"title":"Attendance Policy","url":"/attendance-policy/","category":"Page"},
    {"title":"Canadian Adult Education Credential CAEC-GED Canada","url":"/caec/","category":"Page"},
    {"title":"Career","url":"/career/","category":"Page"},{"title":"CELPIP","url":"/celpip/","category":"Page"},
    {"title": "Course/Mode Change Terms & Policy", "url": "/course-mode-change-terms-policy/", "category": "Page" },
    {"title":"Cheating and Plagiarism","url":"/cheating-and-plagiarism/","category":"Page"},
    {"title":"Code of Conduct","url":"/code-of-conduct/","category":"Page"},
    {"title":"Competitive Exam Prep","url":"/competitive-exam-prep/","category":"Page"},
    {"title":"Computer Usage Policy","url":"/computer-usage-policy/","category":"Page"},
    {"title":"Contact Us","url":"/contact-us/","category":"Page"},{"title":"Course Coding System","url":"/course-coding-system/","category":"Page"},
    {"title":"Course/Mode Change Terms & Policy","url":"/course-mode-change-terms-policy/","category":"Page"},
    {"title":"Examination Policy","url":"/examination-policy/","category":"Page"},
    {"title":"FAQ – Frequently Asked Questions","url":"/faq/","category":"Page"},
    {"title":"Fee Structure 2025–26","url":"/fee-structure/","category":"Page"},
    {"title":"Final Exam and Report Card Information","url":"/final-exam-and-report-card-information/","category":"Page"},
    {"title": "Final Exam", "url": "/final-exam-request/", "category": "Page" },
    {"title":"Full-Time School in Canada (Grades 1–12)","url":"/full-time-school/","category":"Page"},
    {"title":"Gallery","url":"/gallery/","category":"Page"},{"title":"High School Credits","url":"/high-school-credits/","category":"Page"},
    {"title":"High School for Healthcare","url":"/healthcare-programs/","category":"Page"},
    {"title":"Holiday and Special Hours","url":"/holiday-and-special-hours/","category":"Page"},
    {"title":"Home","url":"/","category":"Page"},
    {"title":"IELTS – International English Language Testing System","url":"/ielts/","category":"Page"},
    {"title":"In-Class Student Instructions","url":"/in-class-student-instructions/","category":"Page"},
    {"title":"International Students","url":"/international-student/","category":"Page"},
    {"title":"Late and Missed Assignments Policy","url":"/late-and-missed-assignments-policy/","category":"Page"},
    {"title":"Live Links","url":"/live-links/","category":"Page"},{"title":"My Cart","url":"/cart/","category":"Page"},
    {"title":"Online High School","url":"/online-high-school/","category":"Page"},
    {"title":"Online Student Instructions","url":"/online-student-instructions/","category":"Page"},
    {"title":"Ontario High School Literacy","url":"/ontario-high-school-literacy/","category":"Page"},
    {"title":"Our Blog","url":"/our-blog/","category":"Page"},
    {"title":"Our Blogs – CanSTEM","url":"/our-blogs-canstem/","category":"Page"},
    {"title":"Payment","url":"/payment/","category":"Page"},
    {"title":"Policies","url":"/policies/","category":"Page"},
    {"title":"Privacy Policy","url":"/privacy-policy/","category":"Page"},
    {"title":"Promotions","url":"/promo/","category":"Page"},
    {"title":"PTE English Language Tests | Pearson PTE","url":"/pte/","category":"Page"},
    {"title":"Rating & Reviews","url":"/google-reviews/","category":"Page"},
    {"title":"Refer a Friend","url":"/refer-a-friend/","category":"Page"},
    {"title":"Registration","url":"/registration/","category":"Page"},
    {"title":"Registration Forms","url":"/registration-forms/","category":"Page"},
    {"title":"Safe School Policy","url":"/safe-school-policy/","category":"Page"},
    {"title":"School Policies, Practices, and Procedures​","url":"/school-policies-practices-and-procedures/","category":"Page"},
    {"title":"Student Support","url":"/student-services/","category":"Page"},
    {"title":"OCAS Information and Updates","url":"/ocas/","category":"Page"},
    {"title":"Ontario Secondary School Diploma (OSSD Requirements)","url":"/ossd/","category":"Page"},
    {"title":"OUAC Guidance – 2025–2026 Schedule of Dates","url":"/ouac/","category":"Page"},
    {"title":"How-to Videos | Ontario Universities’ Application …","url":"/how-to-videos/","category":"Page"},
    {"title":"Sitemap","url":"/sitemap/","category":"Page"},
    {"title":"STEM Programs","url":"/stem-programs/","category":"Page"},
    {"title":"Student Achievement The Assessment and Evaluation Policy","url":"/student-achievement-the-assessment-and-evaluation-policy/","category":"Page"},
    {"title":"Summer Camp","url":"/summer-camp/","category":"Page"},
    {"title":"Summer School","url":"/summer-school/","category":"Page"},
    {"title":"TCF & TEF – Canada","url":"/tcf-and-tef/","category":"Page"},
    {"title":"Terms & Conditions","url":"/terms-and-conditions/","category":"Page"},
    {"title":"Tutoring Services & Fees (Grades 1–12, IB, ESL, Test Prep, College)","url":"/tutoring/","category":"Page"},
    {"title":"University Open House","url":"/university-open-house/","category":"Page"},
    //Blogs
    {"title":"7 Easy Steps to a Successful Result","url":"/7-easy-steps-to-a-successful-result/","category":"Blog"},
    {"title":"Adult Learners Perspective on the Shift from GED Testing","url":"/adult-learners-perspective-on-the-shift-from-ged-testing/","category":"Blog"},
    {"title":"All-Inclusive Manual for Finishing the OUAC Application","url":"/all-inclusive-manual-for-finishing-the-ouac-application/","category":"Blog"},
    {"title":"Applying through the OUAC website","url":"/applying-through-the-ouac-website/","category":"Blog"},
    {"title":"Brampton’s Best High Schools","url":"/bramptons-best-high-schools/","category":"Blog"},
    {"title":"Building a Successful Study Plan","url":"/building-a-successful-study-plan/","category":"Blog"},
    {"title":"CanSTEM Education Private School Middle School Program Overview","url":"/canstem-education-private-school-middle-school-program-overview/","category":"Blog"},
    {"title":"CanSTEM Principal Shortlisted Among Top 10 School Principals in Canada 2026 | Education Insider Canada", "url":"/top-10-school-principals-in-canada-2026/", "url":"Blog" },
    {"title":"Exploring Modern Work Realities","url":"/exploring-modern-work-realities/","category":"Blog"},
    {"title":"Exploring Possible Post-Secondary Careers","url":"/exploring-possible-post-secondary-careers/","category":"Blog"},
    {"title":"Forward-Looking Summer Courses in 2024","url":"/forward-looking-summer-courses-in-2024/","category":"Blog"},
    {"title":"Handling the OSSD’s Requirements","url":"/handling-the-ossds-requirements/","category":"Blog"},
    {"title":"How to Achieve Academic Success in High School","url":"/how-to-achieve-academic-success-in-high-school/","category":"Blog"},
    {"title":"Making a Successful Exam Study Plan","url":"/making-a-successful-exam-study-plan/","category":"Blog"},
    {"title":"Manual for Post-Secondary Education","url":"/manual-for-post-secondary-education/","category":"Blog"},
    {"title":"Mississauga Night Schools: Unlock Your Potential","url":"/mississauga-night-schools-unlock-your-potential/","category":"Blog"},
    {"title":"Online Students’ Guide to Back-to-School in 2024","url":"/online-students-guide-to-back-to-school-in-2024/","category":"Blog"},
    {"title":"Ontario Students 2024 Graduation Requirements","url":"/2024-high-school-graduation-requirements/","category":"Blog"},
    {"title":"Ontario Updates Secondary School Graduation Standards","url":"/ontario-updates-secondary-school-graduation-standards/","category":"Blog"},
    {"title":"Ontario’s grad requirements with tech credits and online access","url":"/ontarios-grad-requirements-with-tech-credits-and-online-access/","category":"Blog"},
    {"title":"OUAC & OCAS Applications","url":"/ouac-ocas-applications/","category":"Blog"},
    {"title":"OUAC Program for Students in Ontario","url":"/ouac-program-for-students-in-ontario/","category":"Blog"},
    {"title":"Planning for Summer 2024 College and University Admission","url":"/planning-for-summer-2024-college-and-university-admission/","category":"Blog"},
    {"title":"The Ultimate Guide to Tutoring and Language Coaching in Mississauga & Brampton","url":"/tutoring-language-coaching-mississauga-brampton/","category":"Blog"},
    {"title":"Private School vs Public School in Ontario: Which is Better for Your Child’s Future?","url":"/private-vs-public-school-ontario/","category":"Blog"},
    {"title":"Enrollment Now Open for Full-Time School 2025–26 in Ontario — Grades 1 to 12 at CanSTEM Education","url":"/enrollment-open-full-time-school-ontario-2025-26/","category":"Blog"},
    {"title":"OSSD Requirements 2025: Your Complete Guide to Ontario Secondary School Diploma Success","url":"/ossd-requirements-2025/","category":"Blog"},
    {"title":"Why CanSTEM? The Private School in Brampton That Puts Students First","url":"/why-canstem/","category":"Blog"},
    {"title" :"What is the difference between CanSTEM and other private schools, online and in-person schools?", "url":"/why-canstem-is-different/","category":"Blog" },
    {"title":"Summer Camp 2025 at CanSTEM","url":"/summer-camp-2025-at-canstem/","category":"Blog"},
    {"title":"Summer School 2025 at CanSTEM","url":"/summer-school-2025-at-canstem/","category":"Blog"},
    {"title":"Best Coaching for PTE, IELTS, CELPIP & CAEL in Canada","url":"/english-test-coaching-canada/","category":"Blog"},
    {"title":"The Role of AI in Modern Education","url":"/the-role-of-ai-in-modern-education/","category":"Blog"},
    {"title":"The Role of Parents and Families in Online Schooling","url":"/the-role-of-parents-and-families-in-online-schooling/","category":"Blog"},
    {"title":"2024 High School Graduation Requirements","url":"/2024-high-school-graduation-requirements/","category":"Blog"},
    {"title":"CanSTEM Education Private School","url":"/canstem-education-private-school-3/","category":"Blog"},
    {"title":"The Benefits of One on One Tutoring Services","url":"/the-benefits-of-one-on-one-tutoring-services/","category":"Blog"},
    {"title":"The Value of Private School Education","url":"/the-value-of-private-school-education/","category":"Blog"},
    {"title":"Dual Enrollment Explained – College and High School Credits","url":"/dual-enrollment-explained-college-and-high-school-credits/","category":"Blog"},
    {"title":"5 Things To Consider Before Changing Schools For Your Child","url":"/5-things-to-consider-before-changing-schools-for-your-child/","category":"Blog"},
    {"title":"5 Benefits of Earning College Credit in High School","url":"/5-benefits-of-earning-college-credit-in-high-school/","category":"Blog"},
    {"title":"How Raising Pets Can Help Children Develop Emotional Intelligence","url":"/raising-pets-can-help-children-develop-emotional-intelligence/","category":"Blog"},
    {"title":"5 Ways A Tutor Can Help Students With Exceptionalities","url":"/5-ways-a-tutor-can-help-students-with-exceptionalities/","category":"Blog"},
    {"title":"The Best Way to Balance Study and Fun over the Holidays","url":"/the-best-way-to-balance-study-and-fun-over-the-holidays/","category":"Blog"},
    {"title":"How to Stop Your Child from Hating School","url":"/how-to-stop-your-child-from-hating-school/","category":"Blog"},
    {"title":"Perspectives on Screen Time in a Pandemic","url":"/perspectives-on-screen-time-in-a-pandemic/","category":"Blog"},
    {"title":"What to Wear to a Private School Parent Interview","url":"/what-to-wear-to-a-private-school-parent-interview/","category":"Blog"},
    {"title":"Four Steps to Selecting a School for Your Child","url":"/four-steps-to-selecting-a-school-for-your-child/","category":"Blog"},
    {"title":"Tips To Choose A Tutor","url":"/tips-to-choose-a-tutor/","category":"Blog"},
    {"title":"Tips for Starting High School","url":"/tips-for-starting-high-school/","category":"Blog"},
    {"title":"Boost Grades and Achieve Academic Excellence","url":"/boost-grades-and-achieve-academic-excellence/","category":"Blog"},
    {"title":"University Scholarship Applications for 2024–2025","url":"/university-scholarship-applications-for-2024-2025/","category":"Blog"},
    {"title":"The Importance of Early Preparation for University","url":"/the-importance-of-early-preparation-for-university/","category":"Blog"},
    {"title":"Empowering Mature Students","url":"/empowering-mature-students/","category":"Blog"},
    {"title":"Nursing Prerequisite Courses at CanSTEM Education","url":"/nursing-prerequisite-courses-at-canstem-education/","category":"Blog"},
    {"title":"Online Learning at CanSTEM: Study Anytime, Anywhere","url":"/online-learning-at-canstem/","category":"Blog"},
    {"title":"Why November 11 Matters: Remembrance Day in Canada","url":"/remembrance-day-in-canada/","category":"Blog"},
    {"title":"Impact of IRCC Closing the Student Direct Stream","url":"/impact-of-ircc-closing-the-student-direct-stream/","category":"Blog"},
    {"title":"How Raising Pets Can Help Children Develop Emotional Intelligence (duplicate entry)","url":"/how-raising-pets-can-help-children-develop-emotional-intelligence/","category":"Blog"},
    {"title":"Navigating COVID","url":"/navigating-covid/","category":"Blog"},
    {"title":"How Private Schools Influence Academic Success and Lifelong Outcomes","url":"/academic-success-and-lifelong-outcomes/","category":"Blog"}];
    ...
    input.addEventListener("keydown",e=>{
      ...
      if(!items.length){
        if(e.key==="Enter"&&input.value.trim()){ e.preventDefault(); location.href=productURL(input.value.trim().toUpperCase()); }
        return;
      }
